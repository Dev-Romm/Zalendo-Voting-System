...
export default function Feedback() {
    ...
    async function handleSubmitFeedback(event){
        ...
        const response = await axios.post("http://localhost:5002/api/review", {
  ...
  return (
    <div className="feedback-container">
      <form className="feedback-form" onSubmit={handleSubmitFeedback}>
        ...
        <textarea rows={7} cols={80} className="review" name="review" placeholder="Feel free while giving feedback..." style={{display:"block", margin: "0 auto", backgroundColor:"#fff"}} required>
